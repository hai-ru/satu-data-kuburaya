        ...
        <div class="card-header bg-light">
            ...
            @can('visualisasi-add')
                <div class="float-md-end">
                    <a href="{{ route('visualisasi.create') }}"
                ...
                <table style="width: 100%;" id="datatable" role="grid"
                    ...
                    <thead>
                        <tr role="row">
                            ...
                            <th>KATEGORI</th>
                            <th>DIBUAT OLEH</th>
                            @if (auth()->user()->hasAnyPermission(['visualisasi-read', 'visualisasi-edit', 'visualisasi-delete']))
    ...
    <script>
        $(function() {
            $('#datatable').DataTable({
                ...
                ajax: {
                    url: "{{ route('visualisasi.datatable.api') }}",
                    type: "POST",
                    data: function(d) {
                        d._token = "{{ csrf_token() }}";
                    },
    ...
    @can('visualisasi-delete')
        <script>
            ...
            $('#delete-btn').click(function() {
                ...
                var url = "{{ route('visualisasi.destroy', ':slug') }}"
